// 自动生成模板BeeShopFreightTplException
package bee
...
// 运费模版排除项 结构体  BeeShopFreightTplException
type BeeShopFreightTplException struct {
...
// TableName 运费模版排除项 BeeShopFreightTplException自定义表名 bee_shop_freight_tpl_exception
func (BeeShopFreightTplException) TableName() string {
    return "bee_shop_freight_tpl_exception"
}
