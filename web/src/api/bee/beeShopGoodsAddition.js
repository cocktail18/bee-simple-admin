...
export const createBeeShopGoodsAddition = (data) => {
  return service({
    url: '/beeShopGoodsAddition/createBeeShopGoodsAddition',
    method: 'post',
    data
  })
}
...
export const deleteBeeShopGoodsAddition = (params) => {
  return service({
    url: '/beeShopGoodsAddition/deleteBeeShopGoodsAddition',
    method: 'delete',
    params
  })
}
...
export const deleteBeeShopGoodsAdditionByIds = (params) => {
  return service({
    url: '/beeShopGoodsAddition/deleteBeeShopGoodsAdditionByIds',
    method: 'delete',
    params
  })
}
...
export const updateBeeShopGoodsAddition = (data) => {
  return service({
    url: '/beeShopGoodsAddition/updateBeeShopGoodsAddition',
    method: 'put',
    data
  })
}
...
export const findBeeShopGoodsAddition = (params) => {
  return service({
    url: '/beeShopGoodsAddition/findBeeShopGoodsAddition',
    method: 'get',
    params
  })
}
...
export const getBeeShopGoodsAdditionList = (params) => {
  return service({
    url: '/beeShopGoodsAddition/getBeeShopGoodsAdditionList',
    method: 'get',
    params
  })
}
