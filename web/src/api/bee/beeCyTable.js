...
export const createBeeCyTable = (data) => {
  return service({
    url: '/beeCyTable/createBeeCyTable',
    method: 'post',
    data
  })
}
...
export const deleteBeeCyTable = (params) => {
  return service({
    url: '/beeCyTable/deleteBeeCyTable',
    method: 'delete',
    params
  })
}
...
export const deleteBeeCyTableByIds = (params) => {
  return service({
    url: '/beeCyTable/deleteBeeCyTableByIds',
    method: 'delete',
    params
  })
}
...
export const updateBeeCyTable = (data) => {
  return service({
    url: '/beeCyTable/updateBeeCyTable',
    method: 'put',
    data
  })
}
...
export const getBeeCyTableList = (params) => {
  return service({
    url: '/beeCyTable/getBeeCyTableList',
    method: 'get',
    params
  })
}
