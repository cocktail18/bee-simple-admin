...
export const deleteBeeCouponByIds = (params) => {
  return service({
    url: '/beeCoupon/deleteBeeCouponByIds',
    method: 'delete',
    params
  })
}
...
export const getBeeCouponList = (params) => {
  return service({
    url: '/beeCoupon/getBeeCouponList',
    method: 'get',
    params
  })
}
