...
export const createBeeUserAmount = (data) => {
  return service({
    url: '/beeUserAmount/createBeeUserAmount',
    method: 'post',
    data
  })
}
...
export const deleteBeeUserAmount = (params) => {
  return service({
    url: '/beeUserAmount/deleteBeeUserAmount',
    method: 'delete',
    params
  })
}
...
export const deleteBeeUserAmountByIds = (params) => {
  return service({
    url: '/beeUserAmount/deleteBeeUserAmountByIds',
    method: 'delete',
    params
  })
}
...
export const updateBeeUserAmount = (data) => {
  return service({
    url: '/beeUserAmount/updateBeeUserAmount',
    method: 'put',
    data
  })
}
...
export const findBeeUserAmount = (params) => {
  return service({
    url: '/beeUserAmount/findBeeUserAmount',
    method: 'get',
    params
  })
}
...
export const getBeeUserAmountList = (params) => {
  return service({
    url: '/beeUserAmount/getBeeUserAmountList',
    method: 'get',
    params
  })
}
