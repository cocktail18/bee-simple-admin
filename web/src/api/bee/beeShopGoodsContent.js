...
export const createBeeShopGoodsContent = (data) => {
  return service({
    url: '/beeShopGoodsContent/createBeeShopGoodsContent',
    method: 'post',
    data
  })
}
...
export const deleteBeeShopGoodsContent = (params) => {
  return service({
    url: '/beeShopGoodsContent/deleteBeeShopGoodsContent',
    method: 'delete',
    params
  })
}
...
export const deleteBeeShopGoodsContentByIds = (params) => {
  return service({
    url: '/beeShopGoodsContent/deleteBeeShopGoodsContentByIds',
    method: 'delete',
    params
  })
}
...
export const updateBeeShopGoodsContent = (data) => {
  return service({
    url: '/beeShopGoodsContent/updateBeeShopGoodsContent',
    method: 'put',
    data
  })
}
...
export const findBeeShopGoodsContent = (params) => {
  return service({
    url: '/beeShopGoodsContent/findBeeShopGoodsContent',
    method: 'get',
    params
  })
}
...
export const getBeeShopGoodsContentList = (params) => {
  return service({
    url: '/beeShopGoodsContent/getBeeShopGoodsContentList',
    method: 'get',
    params
  })
}
