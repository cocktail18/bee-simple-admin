...
export const createBeeCashLog = (data) => {
  return service({
    url: '/beeCashLog/createBeeCashLog',
    method: 'post',
    data
  })
}
...
export const deleteBeeCashLog = (params) => {
  return service({
    url: '/beeCashLog/deleteBeeCashLog',
    method: 'delete',
    params
  })
}
...
export const deleteBeeCashLogByIds = (params) => {
  return service({
    url: '/beeCashLog/deleteBeeCashLogByIds',
    method: 'delete',
    params
  })
}
...
export const updateBeeCashLog = (data) => {
  return service({
    url: '/beeCashLog/updateBeeCashLog',
    method: 'put',
    data
  })
}
...
export const getBeeCashLogList = (params) => {
  return service({
    url: '/beeCashLog/getBeeCashLogList',
    method: 'get',
    params
  })
}
