...
export const createBeeShopInfo = (data) => {
  return service({
    url: '/beeShopInfo/createBeeShopInfo',
    method: 'post',
    data
  })
}
...
export const deleteBeeShopInfo = (params) => {
  return service({
    url: '/beeShopInfo/deleteBeeShopInfo',
    method: 'delete',
    params
  })
}
...
export const deleteBeeShopInfoByIds = (params) => {
  return service({
    url: '/beeShopInfo/deleteBeeShopInfoByIds',
    method: 'delete',
    params
  })
}
...
export const updateBeeShopInfo = (data) => {
  return service({
    url: '/beeShopInfo/updateBeeShopInfo',
    method: 'put',
    data
  })
}
...
export const findBeeShopInfo = (params) => {
  return service({
    url: '/beeShopInfo/findBeeShopInfo',
    method: 'get',
    params
  })
}
...
export const getBeeShopInfoList = (params) => {
  return service({
    url: '/beeShopInfo/getBeeShopInfoList',
    method: 'get',
    params
  })
}
