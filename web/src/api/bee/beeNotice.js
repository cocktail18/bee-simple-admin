...
export const deleteBeeNoticeByIds = (params) => {
  return service({
    url: '/beeNotice/deleteBeeNoticeByIds',
    method: 'delete',
    params
  })
}
...
export const getBeeNoticeList = (params) => {
  return service({
    url: '/beeNotice/getBeeNoticeList',
    method: 'get',
    params
  })
}
