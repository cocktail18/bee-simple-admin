...
export const createBeeUserCoupon = (data) => {
  return service({
    url: '/beeUserCoupon/createBeeUserCoupon',
    method: 'post',
    data
  })
}
...
export const deleteBeeUserCoupon = (params) => {
  return service({
    url: '/beeUserCoupon/deleteBeeUserCoupon',
    method: 'delete',
    params
  })
}
...
export const deleteBeeUserCouponByIds = (params) => {
  return service({
    url: '/beeUserCoupon/deleteBeeUserCouponByIds',
    method: 'delete',
    params
  })
}
...
export const updateBeeUserCoupon = (data) => {
  return service({
    url: '/beeUserCoupon/updateBeeUserCoupon',
    method: 'put',
    data
  })
}
...
export const findBeeUserCoupon = (params) => {
  return service({
    url: '/beeUserCoupon/findBeeUserCoupon',
    method: 'get',
    params
  })
}
...
export const getBeeUserCouponList = (params) => {
  return service({
    url: '/beeUserCoupon/getBeeUserCouponList',
    method: 'get',
    params
  })
}
