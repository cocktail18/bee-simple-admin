...
export const deleteBeePayLogByIds = (params) => {
  return service({
    url: '/beePayLog/deleteBeePayLogByIds',
    method: 'delete',
    params
  })
}
...
export const getBeePayLogList = (params) => {
  return service({
    url: '/beePayLog/getBeePayLogList',
    method: 'get',
    params
  })
}
