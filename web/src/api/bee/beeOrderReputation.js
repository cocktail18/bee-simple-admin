...
export const createBeeOrderReputation = (data) => {
  return service({
    url: '/beeOrderReputation/createBeeOrderReputation',
    method: 'post',
    data
  })
}
...
export const deleteBeeOrderReputation = (params) => {
  return service({
    url: '/beeOrderReputation/deleteBeeOrderReputation',
    method: 'delete',
    params
  })
}
...
export const deleteBeeOrderReputationByIds = (params) => {
  return service({
    url: '/beeOrderReputation/deleteBeeOrderReputationByIds',
    method: 'delete',
    params
  })
}
...
export const updateBeeOrderReputation = (data) => {
  return service({
    url: '/beeOrderReputation/updateBeeOrderReputation',
    method: 'put',
    data
  })
}
...
export const findBeeOrderReputation = (params) => {
  return service({
    url: '/beeOrderReputation/findBeeOrderReputation',
    method: 'get',
    params
  })
}
...
export const getBeeOrderReputationList = (params) => {
  return service({
    url: '/beeOrderReputation/getBeeOrderReputationList',
    method: 'get',
    params
  })
}
