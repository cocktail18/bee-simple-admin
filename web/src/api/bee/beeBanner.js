...
export const deleteBeeBannerByIds = (params) => {
  return service({
    url: '/beeBanner/deleteBeeBannerByIds',
    method: 'delete',
    params
  })
}
...
export const getBeeBannerList = (params) => {
  return service({
    url: '/beeBanner/getBeeBannerList',
    method: 'get',
    params
  })
}
