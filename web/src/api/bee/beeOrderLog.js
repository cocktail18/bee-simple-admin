...
export const createBeeOrderLog = (data) => {
  return service({
    url: '/beeOrderLog/createBeeOrderLog',
    method: 'post',
    data
  })
}
...
export const deleteBeeOrderLog = (params) => {
  return service({
    url: '/beeOrderLog/deleteBeeOrderLog',
    method: 'delete',
    params
  })
}
...
export const deleteBeeOrderLogByIds = (params) => {
  return service({
    url: '/beeOrderLog/deleteBeeOrderLogByIds',
    method: 'delete',
    params
  })
}
...
export const updateBeeOrderLog = (data) => {
  return service({
    url: '/beeOrderLog/updateBeeOrderLog',
    method: 'put',
    data
  })
}
...
export const findBeeOrderLog = (params) => {
  return service({
    url: '/beeOrderLog/findBeeOrderLog',
    method: 'get',
    params
  })
}
...
export const getBeeOrderLogList = (params) => {
  return service({
    url: '/beeOrderLog/getBeeOrderLogList',
    method: 'get',
    params
  })
}
