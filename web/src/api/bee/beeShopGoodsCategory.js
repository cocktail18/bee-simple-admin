...
export const createBeeShopGoodsCategory = (data) => {
  return service({
    url: '/beeShopGoodsCategory/createBeeShopGoodsCategory',
    method: 'post',
    data
  })
}
...
export const deleteBeeShopGoodsCategory = (params) => {
  return service({
    url: '/beeShopGoodsCategory/deleteBeeShopGoodsCategory',
    method: 'delete',
    params
  })
}
...
export const deleteBeeShopGoodsCategoryByIds = (params) => {
  return service({
    url: '/beeShopGoodsCategory/deleteBeeShopGoodsCategoryByIds',
    method: 'delete',
    params
  })
}
...
export const updateBeeShopGoodsCategory = (data) => {
  return service({
    url: '/beeShopGoodsCategory/updateBeeShopGoodsCategory',
    method: 'put',
    data
  })
}
...
export const findBeeShopGoodsCategory = (params) => {
  return service({
    url: '/beeShopGoodsCategory/findBeeShopGoodsCategory',
    method: 'get',
    params
  })
}
...
export const getBeeShopGoodsCategoryList = (params) => {
  return service({
    url: '/beeShopGoodsCategory/getBeeShopGoodsCategoryList',
    method: 'get',
    params
  })
}
