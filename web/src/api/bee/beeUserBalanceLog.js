...
export const createBeeUserBalanceLog = (data) => {
  return service({
    url: '/beeUserBalanceLog/createBeeUserBalanceLog',
    method: 'post',
    data
  })
}
...
export const deleteBeeUserBalanceLog = (params) => {
  return service({
    url: '/beeUserBalanceLog/deleteBeeUserBalanceLog',
    method: 'delete',
    params
  })
}
...
export const deleteBeeUserBalanceLogByIds = (params) => {
  return service({
    url: '/beeUserBalanceLog/deleteBeeUserBalanceLogByIds',
    method: 'delete',
    params
  })
}
...
export const updateBeeUserBalanceLog = (data) => {
  return service({
    url: '/beeUserBalanceLog/updateBeeUserBalanceLog',
    method: 'put',
    data
  })
}
...
export const findBeeUserBalanceLog = (params) => {
  return service({
    url: '/beeUserBalanceLog/findBeeUserBalanceLog',
    method: 'get',
    params
  })
}
...
export const getBeeUserBalanceLogList = (params) => {
  return service({
    url: '/beeUserBalanceLog/getBeeUserBalanceLogList',
    method: 'get',
    params
  })
}
