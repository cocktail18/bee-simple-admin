...
export const createBeeShopGoods = (data) => {
  return service({
    url: '/beeShopGoods/createBeeShopGoods',
    method: 'post',
    data
  })
}
...
export const deleteBeeShopGoods = (params) => {
  return service({
    url: '/beeShopGoods/deleteBeeShopGoods',
    method: 'delete',
    params
  })
}
...
export const deleteBeeShopGoodsByIds = (params) => {
  return service({
    url: '/beeShopGoods/deleteBeeShopGoodsByIds',
    method: 'delete',
    params
  })
}
...
export const updateBeeShopGoods = (data) => {
  return service({
    url: '/beeShopGoods/updateBeeShopGoods',
    method: 'put',
    data
  })
}
...
export const findBeeShopGoods = (params) => {
  return service({
    url: '/beeShopGoods/findBeeShopGoods',
    method: 'get',
    params
  })
}
...
export const getBeeShopGoodsList = (params) => {
  return service({
    url: '/beeShopGoods/getBeeShopGoodsList',
    method: 'get',
    params
  })
}
