...
export const createBeeLogistics = (data) => {
  return service({
    url: '/beeLogistics/createBeeLogistics',
    method: 'post',
    data
  })
}
...
export const deleteBeeLogistics = (params) => {
  return service({
    url: '/beeLogistics/deleteBeeLogistics',
    method: 'delete',
    params
  })
}
...
export const deleteBeeLogisticsByIds = (params) => {
  return service({
    url: '/beeLogistics/deleteBeeLogisticsByIds',
    method: 'delete',
    params
  })
}
...
export const updateBeeLogistics = (data) => {
  return service({
    url: '/beeLogistics/updateBeeLogistics',
    method: 'put',
    data
  })
}
...
export const findBeeLogistics = (params) => {
  return service({
    url: '/beeLogistics/findBeeLogistics',
    method: 'get',
    params
  })
}
...
export const getBeeLogisticsList = (params) => {
  return service({
    url: '/beeLogistics/getBeeLogisticsList',
    method: 'get',
    params
  })
}
