...
export const createBeeWxConfig = (data) => {
  return service({
    url: '/beeWxConfig/createBeeWxConfig',
    method: 'post',
    data
  })
}
...
export const deleteBeeWxConfig = (params) => {
  return service({
    url: '/beeWxConfig/deleteBeeWxConfig',
    method: 'delete',
    params
  })
}
...
export const deleteBeeWxConfigByIds = (params) => {
  return service({
    url: '/beeWxConfig/deleteBeeWxConfigByIds',
    method: 'delete',
    params
  })
}
...
export const updateBeeWxConfig = (data) => {
  return service({
    url: '/beeWxConfig/updateBeeWxConfig',
    method: 'put',
    data
  })
}
...
export const findBeeWxConfig = (params) => {
  return service({
    url: '/beeWxConfig/findBeeWxConfig',
    method: 'get',
    params
  })
}
...
export const getBeeWxConfigList = (params) => {
  return service({
    url: '/beeWxConfig/getBeeWxConfigList',
    method: 'get',
    params
  })
}
