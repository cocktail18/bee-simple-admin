...
export const deleteBeeRegionByIds = (params) => {
  return service({
    url: '/beeRegion/deleteBeeRegionByIds',
    method: 'delete',
    params
  })
}
...
export const getBeeRegionList = (params) => {
  return service({
    url: '/beeRegion/getBeeRegionList',
    method: 'get',
    params
  })
}
...
export const getBeeRegionCityTree = (params) => {
  return service({
    url: '/beeRegion/getBeeRegionCityTree',
    method: 'get',
    params
  })
}
