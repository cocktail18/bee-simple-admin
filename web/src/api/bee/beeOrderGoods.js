...
export const createBeeOrderGoods = (data) => {
  return service({
    url: '/beeOrderGoods/createBeeOrderGoods',
    method: 'post',
    data
  })
}
...
export const deleteBeeOrderGoods = (params) => {
  return service({
    url: '/beeOrderGoods/deleteBeeOrderGoods',
    method: 'delete',
    params
  })
}
...
export const deleteBeeOrderGoodsByIds = (params) => {
  return service({
    url: '/beeOrderGoods/deleteBeeOrderGoodsByIds',
    method: 'delete',
    params
  })
}
...
export const updateBeeOrderGoods = (data) => {
  return service({
    url: '/beeOrderGoods/updateBeeOrderGoods',
    method: 'put',
    data
  })
}
...
export const findBeeOrderGoods = (params) => {
  return service({
    url: '/beeOrderGoods/findBeeOrderGoods',
    method: 'get',
    params
  })
}
...
export const getBeeOrderGoodsList = (params) => {
  return service({
    url: '/beeOrderGoods/getBeeOrderGoodsList',
    method: 'get',
    params
  })
}
