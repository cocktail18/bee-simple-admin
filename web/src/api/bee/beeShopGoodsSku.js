...
export const createBeeShopGoodsSku = (data) => {
  return service({
    url: '/beeShopGoodsSku/createBeeShopGoodsSku',
    method: 'post',
    data
  })
}
...
export const deleteBeeShopGoodsSku = (params) => {
  return service({
    url: '/beeShopGoodsSku/deleteBeeShopGoodsSku',
    method: 'delete',
    params
  })
}
...
export const deleteBeeShopGoodsSkuByIds = (params) => {
  return service({
    url: '/beeShopGoodsSku/deleteBeeShopGoodsSkuByIds',
    method: 'delete',
    params
  })
}
...
export const updateBeeShopGoodsSku = (data) => {
  return service({
    url: '/beeShopGoodsSku/updateBeeShopGoodsSku',
    method: 'put',
    data
  })
}
...
export const findBeeShopGoodsSku = (params) => {
  return service({
    url: '/beeShopGoodsSku/findBeeShopGoodsSku',
    method: 'get',
    params
  })
}
...
export const getBeeShopGoodsSkuList = (params) => {
  return service({
    url: '/beeShopGoodsSku/getBeeShopGoodsSkuList',
    method: 'get',
    params
  })
}
