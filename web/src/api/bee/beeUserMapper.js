...
export const createBeeUserMapper = (data) => {
  return service({
    url: '/beeUserMapper/createBeeUserMapper',
    method: 'post',
    data
  })
}
...
export const deleteBeeUserMapper = (params) => {
  return service({
    url: '/beeUserMapper/deleteBeeUserMapper',
    method: 'delete',
    params
  })
}
...
export const deleteBeeUserMapperByIds = (params) => {
  return service({
    url: '/beeUserMapper/deleteBeeUserMapperByIds',
    method: 'delete',
    params
  })
}
...
export const updateBeeUserMapper = (data) => {
  return service({
    url: '/beeUserMapper/updateBeeUserMapper',
    method: 'put',
    data
  })
}
...
export const findBeeUserMapper = (params) => {
  return service({
    url: '/beeUserMapper/findBeeUserMapper',
    method: 'get',
    params
  })
}
...
export const getBeeUserMapperList = (params) => {
  return service({
    url: '/beeUserMapper/getBeeUserMapperList',
    method: 'get',
    params
  })
}
