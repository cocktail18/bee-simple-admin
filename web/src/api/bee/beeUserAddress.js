...
export const createBeeUserAddress = (data) => {
  return service({
    url: '/beeUserAddress/createBeeUserAddress',
    method: 'post',
    data
  })
}
...
export const deleteBeeUserAddress = (params) => {
  return service({
    url: '/beeUserAddress/deleteBeeUserAddress',
    method: 'delete',
    params
  })
}
...
export const deleteBeeUserAddressByIds = (params) => {
  return service({
    url: '/beeUserAddress/deleteBeeUserAddressByIds',
    method: 'delete',
    params
  })
}
...
export const updateBeeUserAddress = (data) => {
  return service({
    url: '/beeUserAddress/updateBeeUserAddress',
    method: 'put',
    data
  })
}
...
export const findBeeUserAddress = (params) => {
  return service({
    url: '/beeUserAddress/findBeeUserAddress',
    method: 'get',
    params
  })
}
...
export const getBeeUserAddressList = (params) => {
  return service({
    url: '/beeUserAddress/getBeeUserAddressList',
    method: 'get',
    params
  })
}
