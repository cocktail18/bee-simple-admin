...
export const createBeeComment = (data) => {
  return service({
    url: '/beeComment/createBeeComment',
    method: 'post',
    data
  })
}
...
export const deleteBeeComment = (params) => {
  return service({
    url: '/beeComment/deleteBeeComment',
    method: 'delete',
    params
  })
}
...
export const deleteBeeCommentByIds = (params) => {
  return service({
    url: '/beeComment/deleteBeeCommentByIds',
    method: 'delete',
    params
  })
}
...
export const updateBeeComment = (data) => {
  return service({
    url: '/beeComment/updateBeeComment',
    method: 'put',
    data
  })
}
...
export const getBeeCommentList = (params) => {
  return service({
    url: '/beeComment/getBeeCommentList',
    method: 'get',
    params
  })
}
