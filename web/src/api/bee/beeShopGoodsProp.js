...
export const createBeeShopGoodsProp = (data) => {
  return service({
    url: '/beeShopGoodsProp/createBeeShopGoodsProp',
    method: 'post',
    data
  })
}
...
export const deleteBeeShopGoodsProp = (params) => {
  return service({
    url: '/beeShopGoodsProp/deleteBeeShopGoodsProp',
    method: 'delete',
    params
  })
}
...
export const deleteBeeShopGoodsPropByIds = (params) => {
  return service({
    url: '/beeShopGoodsProp/deleteBeeShopGoodsPropByIds',
    method: 'delete',
    params
  })
}
...
export const updateBeeShopGoodsProp = (data) => {
  return service({
    url: '/beeShopGoodsProp/updateBeeShopGoodsProp',
    method: 'put',
    data
  })
}
...
export const findBeeShopGoodsProp = (params) => {
  return service({
    url: '/beeShopGoodsProp/findBeeShopGoodsProp',
    method: 'get',
    params
  })
}
...
export const getBeeShopGoodsPropList = (params) => {
  return service({
    url: '/beeShopGoodsProp/getBeeShopGoodsPropList',
    method: 'get',
    params
  })
}
