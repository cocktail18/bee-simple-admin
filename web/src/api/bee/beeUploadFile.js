...
export const createBeeUploadFile = (data) => {
  return service({
    url: '/beeUploadFile/createBeeUploadFile',
    method: 'post',
    data
  })
}
...
export const deleteBeeUploadFile = (params) => {
  return service({
    url: '/beeUploadFile/deleteBeeUploadFile',
    method: 'delete',
    params
  })
}
...
export const deleteBeeUploadFileByIds = (params) => {
  return service({
    url: '/beeUploadFile/deleteBeeUploadFileByIds',
    method: 'delete',
    params
  })
}
...
export const updateBeeUploadFile = (data) => {
  return service({
    url: '/beeUploadFile/updateBeeUploadFile',
    method: 'put',
    data
  })
}
...
export const findBeeUploadFile = (params) => {
  return service({
    url: '/beeUploadFile/findBeeUploadFile',
    method: 'get',
    params
  })
}
...
export const getBeeUploadFileList = (params) => {
  return service({
    url: '/beeUploadFile/getBeeUploadFileList',
    method: 'get',
    params
  })
}
