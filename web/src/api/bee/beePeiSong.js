...
export const createBeePeiSong = (data) => {
  return service({
    url: '/beePeiSong/createBeePeiSong',
    method: 'post',
    data
  })
}
...
export const deleteBeePeiSong = (params) => {
  return service({
    url: '/beePeiSong/deleteBeePeiSong',
    method: 'delete',
    params
  })
}
...
export const deleteBeePeiSongByIds = (params) => {
  return service({
    url: '/beePeiSong/deleteBeePeiSongByIds',
    method: 'delete',
    params
  })
}
...
export const updateBeePeiSong = (data) => {
  return service({
    url: '/beePeiSong/updateBeePeiSong',
    method: 'put',
    data
  })
}
...
export const getBeePeiSongList = (params) => {
  return service({
    url: '/beePeiSong/getBeePeiSongList',
    method: 'get',
    params
  })
}
