...
export const createBeeWxPayConfig = (data) => {
  return service({
    url: '/beeWxPayConfig/createBeeWxPayConfig',
    method: 'post',
    data
  })
}
...
export const deleteBeeWxPayConfig = (params) => {
  return service({
    url: '/beeWxPayConfig/deleteBeeWxPayConfig',
    method: 'delete',
    params
  })
}
...
export const deleteBeeWxPayConfigByIds = (params) => {
  return service({
    url: '/beeWxPayConfig/deleteBeeWxPayConfigByIds',
    method: 'delete',
    params
  })
}
...
export const updateBeeWxPayConfig = (data) => {
  return service({
    url: '/beeWxPayConfig/updateBeeWxPayConfig',
    method: 'put',
    data
  })
}
...
export const findBeeWxPayConfig = (params) => {
  return service({
    url: '/beeWxPayConfig/findBeeWxPayConfig',
    method: 'get',
    params
  })
}
...
export const getBeeWxPayConfigList = (params) => {
  return service({
    url: '/beeWxPayConfig/getBeeWxPayConfigList',
    method: 'get',
    params
  })
}
