...
export const createBeeOrderLogistics = (data) => {
  return service({
    url: '/beeOrderLogistics/createBeeOrderLogistics',
    method: 'post',
    data
  })
}
...
export const deleteBeeOrderLogistics = (params) => {
  return service({
    url: '/beeOrderLogistics/deleteBeeOrderLogistics',
    method: 'delete',
    params
  })
}
...
export const deleteBeeOrderLogisticsByIds = (params) => {
  return service({
    url: '/beeOrderLogistics/deleteBeeOrderLogisticsByIds',
    method: 'delete',
    params
  })
}
...
export const updateBeeOrderLogistics = (data) => {
  return service({
    url: '/beeOrderLogistics/updateBeeOrderLogistics',
    method: 'put',
    data
  })
}
...
export const findBeeOrderLogistics = (params) => {
  return service({
    url: '/beeOrderLogistics/findBeeOrderLogistics',
    method: 'get',
    params
  })
}
...
export const getBeeOrderLogisticsList = (params) => {
  return service({
    url: '/beeOrderLogistics/getBeeOrderLogisticsList',
    method: 'get',
    params
  })
}
