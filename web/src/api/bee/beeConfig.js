...
export const deleteBeeConfigByIds = (params) => {
  return service({
    url: '/beeConfig/deleteBeeConfigByIds',
    method: 'delete',
    params
  })
}
...
export const getBeeConfigList = (params) => {
  return service({
    url: '/beeConfig/getBeeConfigList',
    method: 'get',
    params
  })
}
