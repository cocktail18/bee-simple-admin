...
export const createBeeShopGoodsImages = (data) => {
  return service({
    url: '/beeShopGoodsImages/createBeeShopGoodsImages',
    method: 'post',
    data
  })
}
...
export const deleteBeeShopGoodsImages = (params) => {
  return service({
    url: '/beeShopGoodsImages/deleteBeeShopGoodsImages',
    method: 'delete',
    params
  })
}
...
export const deleteBeeShopGoodsImagesByIds = (params) => {
  return service({
    url: '/beeShopGoodsImages/deleteBeeShopGoodsImagesByIds',
    method: 'delete',
    params
  })
}
...
export const updateBeeShopGoodsImages = (data) => {
  return service({
    url: '/beeShopGoodsImages/updateBeeShopGoodsImages',
    method: 'put',
    data
  })
}
...
export const findBeeShopGoodsImages = (params) => {
  return service({
    url: '/beeShopGoodsImages/findBeeShopGoodsImages',
    method: 'get',
    params
  })
}
...
export const getBeeShopGoodsImagesList = (params) => {
  return service({
    url: '/beeShopGoodsImages/getBeeShopGoodsImagesList',
    method: 'get',
    params
  })
}
