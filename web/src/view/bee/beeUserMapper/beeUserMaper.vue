<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="uid字段" prop="uid" width="120" />
        <el-table-column align="left" label="source字段" prop="source" width="120" />
        <el-table-column align="left" label="openId字段" prop="openId" width="120" />
        <el-table-column align="left" label="unionId字段" prop="unionId" width="120" />
        <el-table-column align="left" label="已删除" prop="isDeleted" width="120">
          <template #default="scope">{{ formatBoolean(scope.row.isDeleted) }}</template>
        </el-table-column>
        <el-table-column align="left" label="创建时间" prop="dateAdd" width="180">
...
<!--            </el-form-item>-->
            ...
            <el-form-item label="source字段:"  prop="source" >
              <el-input v-model.number="formData.source" :clearable="true" placeholder="请输入source字段" />
            </el-form-item>
            <el-form-item label="openId字段:"  prop="openId" >
